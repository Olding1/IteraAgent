...
测试场景:
1. 使用真实 API (从 .env 加载)
2. 使用真实项目文档 (IteraAgent项目计划书.md, IteraAgent_详细实施计划.md)
3. 生成 RAG Agent
4. 自动生成 DeepEval 测试
5. 验证所有 Phase 4 优化点
...
from src.core import PM, GraphDesigner, Compiler, RAGBuilder, TestGenerator as CoreTestGenerator, DeepEvalTestConfig
...
class Phase4RealAPITest:
    ...
    async def run_all_tests(self):
        ...
        print("=" * 80)
        print()
        print("📋 用户需求: 创建一个能够回答 IteraAgent 项目文档问题的 RAG Agent")
        print("📁 文档: IteraAgent项目计划书.md, IteraAgent_详细实施计划.md")
        print()
    ...
    async def test_5_test_generator(self):
        ...
        test_gen = CoreTestGenerator(self.builder)
...
║  测试文档: IteraAgent项目计划书.md, IteraAgent_详细实施计划.md               ║
║                                                                              ║
║  优化验证:                                                                   ║
