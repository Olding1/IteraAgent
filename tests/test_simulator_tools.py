...
from src.schemas import GraphStructure, NodeDef, EdgeDef, ConditionalEdgeDef, StateSchema, PatternConfig, PatternType
...
"""
    ...
    edges = [
        EdgeDef(source="tool_tavily", target="agent")
    ]
