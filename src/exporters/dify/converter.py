...
将 Agent Zero 的 Graph 结构转换为 Dify 的 YAML 格式
"""
...
class AgentZeroToDifyConverter:
    ...
    def convert(self) -> DifyApp:
        ...
        app = DifyApp(
            app={
                ...
                "icon": "🤖",
                "description": self.graph.pattern.description or f"{self.agent_name} - Generated by Agent Zero",
    ...
    def _create_nodes(self) -> List[DifyNode]:
        ...
        for node in self.graph.nodes:
            ...
            if node.type == "rag":
                print(f"⚠️  跳过 RAG 节点 '{node.id}'（需要在 Dify 中手动添加 Knowledge Retrieval 节点）")
